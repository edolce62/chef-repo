Vagrant.configure("2") do |config|
  ...
  config.vm.provision :chef_client do |chef|
    ...
    chef.chef_server_url = "https://api.chef.io/organizations/dolce"
    chef.validation_key_path = ".chef/dolce-validator.pem"
    chef.validation_client_name = "dolce-validator"
